...
class ResponsiblePerson
{
    ...
    public String drink() { if(person.getAge() < 18) return "too young"; else return person.drink(); }
    public String drive() { if(person.getAge() < 16) return "too young"; else return person.drive(); }
